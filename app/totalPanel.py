...
class TabPanel(wx.Panel):
	...
	def initPlot(self):
		...
		self.axeE.set_title('Total Simulation Plot')
	...
	def recordData(self, fileName):
		...
		filename = commonName+'-['+self.date+']-Total'+'.csv'
...
class DemoFrame(wx.Frame):
	def __init__(self):
		wx.Frame.__init__(self, None, wx.ID_ANY, "Total Graph")
		panel = TabPanel(self)		
		self.Show()
