...
class TabPanel(wx.Panel):
	...
	def initPlot(self):
		...
		self.axeE.set_title('Furnace 2 Simulation Plot')
	...
	def recordData(self, fileName):
		...
		filename = commonName+'-['+self.date+']-Reheating'+'.csv'
	...
	def plotFromFile(self, fileName):
		...
		if len(fileName) > 0:
			...
			commonName = "/home/pi/Desktop/CAL/cal2.0/app/results/"+fileName
			filename = commonName+'-Reheating'+'.csv'
...
class DemoFrame(wx.Frame):
	def __init__(self):
		wx.Frame.__init__(self, None, wx.ID_ANY, "Reheat Graph")
		panel = TabPanel(self)		
		self.Show()
