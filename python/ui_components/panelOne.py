...
class TabPanelOne(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.ax2.set_ylabel('Real-time Furnace temprature(C)', color='g')
        self.ax2.set_ybound(lower=ymin, upper=ymax)

        self.ax3 = self.axes.twinx()
        self.ax3.set_ylabel('Real-time Sample temprature(C)', color='r')
